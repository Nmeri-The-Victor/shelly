    ...
    return Assistant(
        ...
        knowledge_base=AssistantKnowledge(
            vector_db=PgVector2(
                ...
                embedder=OllamaEmbedder(model="jmorgan/nomic-embed-text", dimensions=768),
            ),
            # 3 references are added to the prompt
            num_documents=3,
        ),
        description="You are a helpful Study Assistant called 'Shelly' and your goal is to assist the user in the best way possible with thier studying.",
        instructions=[
