...
st.title("Shelly your study assistant!!!")
...
def main() -> None:
    ...
    if len(assistant_chat_history) > 0:
        ...
        st.session_state["messages"] = [{"role": "assistant", "content": "Generating resources..."}]
    ...
    if rag_assistant.storage:
        ...
        new_rag_assistant_run_id = st.selectbox("Chat ID", options=rag_assistant_run_ids)
